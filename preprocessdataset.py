...
df = pd.read_csv('rawDataset2.csv')
...
for i, review in enumerate(list(df['review'])):
    sentpreprocess=preprocess(getreview[i])
    contentreview.append(sentpreprocess)
    contentsentiment.append((getsentiment[i]))

data = {'review': contentreview, 'sentiment': contentsentiment}

df3 = pd.DataFrame(data)
df3.to_csv("preprocessDataset2.csv", index=False)